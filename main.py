...
label = tk.Label(root, text='Как звать тебя?', width=52, justify="center",
                 fg="white", font=("Helvetica", 15), bg="red")
...
button = tk.Button(root, text='Нажми кнопку после ввода ответа!', width=42, command=Hello,
